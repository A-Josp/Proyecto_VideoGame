...
class Menu:
    def __init__(self, dc_game):
        ...
        self.fondo = pygame.image.load('imagenes/fondo.png')  # Ruta al archivo de imagen de fondo
        self.fondo = pygame.transform.scale(self.fondo, (self.ajustes.anchura, self.ajustes.altura))  # Ajustar el tamaño a la pantalla

    def mostrar_menu(self):
        self.screen.blit(self.fondo, (0, 0))  # Dibujar la imagen de fondo
